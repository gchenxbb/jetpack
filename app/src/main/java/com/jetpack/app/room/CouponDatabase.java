...
public abstract class CouponDatabase extends RoomDatabase {
    ...
    public static CouponDatabase mCouponDatabase;
    ...
    public static CouponDatabase getInstance() {
...
//                if (mCouponDatabase == null) {
                    ...
                    mCouponDatabase = Room.databaseBuilder(mContext, CouponDatabase.class, DB_NAME)
